...
export BUILD_BOX_RELEASE_NOTES="Funtoo 1.3, Debian Kernel 4.9.130-2 LTS, GCC 7.4.1, VirtualBox Guest Additions 5.2.22, Ansible"		# edit this to reflect actual setup
